...
export default class VLCalculator extends Component {
  ...
  constructor(props){
    super(props)
    this.state={listData:[{multiple:2},{multiple:3},{multiple:4},{multiple:5},
      ...
      <View style={styles.container}>
       ...
       <View style={styles.topView}>
        ...
        <View style={styles.textView}>
          <TextInput onChangeText={(text) => this.money=text} style={styles.textInput} defaultValue="1000" keyboardType="decimal-pad"/>
        </View>
        <Text style={styles.wanyuan}>万元</Text>
        <Button style={styles.saveButton} titleStyle={styles.saveTitle} title="确定" onPress={this.calculator}/>
       </View>
